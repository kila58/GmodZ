...
SWEP.RRise					= 0.005
SWEP.IronSightsPos 			= Vector (4.655, 0.1, 1.05)
SWEP.IronSightsAng 			= Vector (-0.57, 0.02, 0)
...
SWEP.VElements = {
	...
	["m145"] = {
		...
		AuxIronSightsPos = Vector (4.655, 0.1, 1),
		AuxIronSightsAng = Vector (-0.8, 0, 0),
		--RRise = -0.005,
		--RSlide = 0.0045,
		skin = 0,
		bodygroup = {}
	...
	["rds"] = {
		...
		AuxIronSightsAng = Vector (-1.1, 0, 0),
		surpresslightning = false,
		--material = "models/props_combine/metal_combinebridge001",
		skin = 0,
		bodygroup = {}
