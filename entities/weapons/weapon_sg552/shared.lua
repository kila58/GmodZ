...
SWEP.RSlide					= 0.0010
SWEP.RRise					= 0.001
SWEP.IronSightsPos 			= Vector (6.825, 0, 3.3)
SWEP.IronSightsAng 			= Vector (0.66, 0.28, 0)
...
SWEP.VElements = {
	...
	["m145"] = {
		...
		AuxIronSightsPos 			= Vector (6.825, 0, 2.975),
		AuxIronSightsAng 			= Vector (-0.3, 0.28, 0),
		skin = 0,
		bodygroup = {}
		},
	["rds"] = {
		...
		surpresslightning = false,
		--material = "models/props_combine/metal_combinebridge001",
		AuxIronSightsPos 			= Vector (6.825, 0, 3.3),
