...
function SWEP:AttachmentCheck()
	...
	-- exported from stronkhold
	PrimaryWeapons = {}
	PrimaryWeapons["weapon_sh_ak47"] =        { type="ar2", name="AK-47", price=419.99, model="models/weapons/w_rif_ak47.mdl" }
	PrimaryWeapons["weapon_sh_aug"] =         { type="ar2", name="STEYR AUG-A1", price=1199.99, model="models/weapons/w_rif_aug.mdl" }
	--GM.PrimaryWeapons["weapon_sh_famas"] =       { type="ar2", name="FAMAS-F1", price=399.99, model="models/weapons/w_rif_famas.mdl" }
	PrimaryWeapons["weapon_sh_galil"] =       { type="ar2", name="Galil SAR", price=599.99, model="models/weapons/w_rif_galil.mdl" }
	PrimaryWeapons["weapon_sh_m4a2"] =        { type="ar2", name="M4A2", price=699.99, model="models/weapons/w_rif_m4a1.mdl" }
	PrimaryWeapons["weapon_sh_sg552"] =       { type="ar2", name="SIG SG-552", price=1269.99, model="models/weapons/w_rif_sg552.mdl" }
	PrimaryWeapons["weapon_sh_pumpshotgun"] = { type="buckshot", name="M3 Super 90", price=249.99, model="models/weapons/w_shot_m3super90.mdl" }
	PrimaryWeapons["weapon_sh_xm1014"] =      { type="buckshot", name="XM1014", price=619.99, model="models/weapons/w_shot_xm1014.mdl" }
	PrimaryWeapons["weapon_sh_mp5a4"] =       { type="smg1", name="HK MP-5A5", price=0, model="models/weapons/w_smg_mp5.mdl" }
	PrimaryWeapons["weapon_sh_p90"] =         { type="smg1", name="FN P90", price=1099.99, model="models/weapons/w_smg_p90.mdl" }
	PrimaryWeapons["weapon_sh_ump_45"] =      { type="smg1", name="HK UMP-45", price=1199.99, model="models/weapons/w_smg_ump45.mdl" }
	PrimaryWeapons["weapon_sh_awp"] =         { type="ar2", name="UTG L96", price=2499.99, model="models/weapons/w_snip_awp.mdl", --[[fov=120, buyfov=120]] }
	PrimaryWeapons["weapon_sh_g3sg1"] =       { type="ar2", name="HK G3SG1", price=1099.99, model="models/weapons/w_snip_g3sg1.mdl" }
	PrimaryWeapons["weapon_sh_scout"] =       { type="ar2", name="STEYR SCOUT", price=999.99, model="models/weapons/w_snip_scout.mdl" }
	--GM.PrimaryWeapons["weapon_sh_sg550"] =       { type="ar2", name="SIG SG-550", price=1899.99, model="models/weapons/w_snip_sg550.mdl" }
	PrimaryWeapons["weapon_sh_m249"] =        { type="ar2", name="M249 SAW", price=1699.99, model="models/weapons/w_mach_m249para.mdl" }
	PrimaryWeapons["weapon_sh_rpg"] =         { type="rpg_round", name="RPG", price=1999.99, model="models/weapons/w_rocket_launcher.mdl", offset=Vector(-10,-15,0), ang=Angle(0,0,0), fov=70 }

	SecondaryWeapons = {}
	SecondaryWeapons["weapon_sh_deagle"] =       { type="pistol", name="Desert Eagle .44", price=1099.99, model="models/weapons/w_pist_deagle.mdl" }
	SecondaryWeapons["weapon_sh_usp"] =          { type="pistol", name="HK USP .45", price=599.99, model="models/weapons/w_pist_usp.mdl" }
	SecondaryWeapons["weapon_sh_five-seven"] =   { type="pistol", name="FN Five-Seven", price=399.99, model="models/weapons/w_pist_fiveseven.mdl" }
	SecondaryWeapons["weapon_sh_glock18"] =      { type="pistol", name="Glock 18", price=999.99, model="models/weapons/w_pist_glock18.mdl" }
	SecondaryWeapons["weapon_sh_p228"] =         { type="pistol", name="SIG-SAUER P228", price=0, model="models/weapons/w_pist_p228.mdl" }
	SecondaryWeapons["weapon_sh_tmp"] =          { type="smg1", name="STEYR TMP", price=1599.99, model="models/weapons/w_smg_tmp.mdl", auto=true }
	SecondaryWeapons["weapon_sh_mac10-45"] =     { type="smg1", name="MAC-10 .45", price=1699.99, model="models/weapons/w_smg_mac10.mdl", auto=true }
	SecondaryWeapons["weapon_sh_mac11-380"] =    { type="smg1", name="MAC-11 .380", price=1299.99, model="models/weapons/w_smg_mac10.mdl", auto=true }
	...
	local primary = PrimaryWeapons[self:GetClass()]
	local seconday = SecondaryWeapons[self:GetClass()]
	...
	if IsValid( self.Owner ) then
		...
		--[[for _, n in pairs( names ) do
			...
			--if not self.Owner:HasAttachment( typ, self:GetClass(), n ) or self.Owner:GetInfoNum( var, 0 ) == 0 then
				--self.VElements[n] = nil
				self.VElements.rds = nil
				self.VElements.scope = nil
			--end
		end]]

		self.VElements.rds = nil
		self.VElements.scope = nil
		self.VElements.suppressor = nil
...
function SWEP:Deploy()
	...
	if self.FireSelect ~= 0 then
		...
		self:SetNetworkedBool( "FireMode", saved_firemode )
