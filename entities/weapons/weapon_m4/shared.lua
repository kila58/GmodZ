...
SWEP.IronSightsAng = Vector (3, 1.45, 2.7)
...
SWEP.VElements = {
	...
	["m145"] = {
		...
		AuxIronSightsPos = Vector (6.07, 0.1, 0.845),
		AuxIronSightsAng = Vector (1.4, 1.5, 3.6),
		RRise = -0.01,
		RSlide = 0.0045,
		skin = 0,
		bodygroup = {}
	...
	["rds"] = {
		...
		surpresslightning = false,
		--material = "models/props_combine/metal_combinebridge001",
		AuxIronSightsPos = Vector (6.065, 0.1, 0.85),
		AuxIronSightsAng = Vector (2.3, 1.3, 3.6),
		skin = 0,
		bodygroup = {}
		},
	["scope"] = {
